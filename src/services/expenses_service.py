...
class ExpensesService():
    ...
    async def create (self, data: newexpenses_recuest) -> expenses_response:
        ...
        return expenses_response.model_validate(new_expense)
    ...
    async def search (self, expense_id: int) -> expenses_response:
        ...
        return expenses_response.model_validate(expense)
    ...
    async def __get_expenses_list(self, offset: int, limit: int) -> List[expenses_response]:
